...
def run_tree(data_path, file_date, file_suffix):
    ...
    # overall:
    evaluation('Decision Tree' + ', overall:', label_test, pred)

    # rare:
    print(len(test_rare_index))
    evaluation('Decision Tree' + ', rare:', label_test[test_rare_index],
...
if __name__ == "__main__":
    run_tree("../data", file_date="191210", file_suffix="00")