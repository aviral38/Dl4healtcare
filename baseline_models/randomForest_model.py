...
#     map_path='./data/graph_data/191210/diseases-map-191210'+'.txt'
#     print("ka :", map_path)
#     ######       ########
...
def run_forest(data_path, file_date, file_suffix, num_tree):
    ...
    # overall:
    evaluation('Random Forest' + ', overall:', label_test, pred)

    # rare:
    print(len(test_rare_index))
    evaluation('Random Forest' + ', rare:', label_test[test_rare_index],
...
if __name__ == "__main__":
    run_forest("../data", file_date="191210", file_suffix="00")